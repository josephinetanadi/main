...
/**
 * Represents a storage for {@link ProjectList}.
 */
public interface ProjectListStorage {
    ...
    /**
     * Returns ProjectList data as a {@link ReadOnlyProjectList}. Returns
    ...
    void backupProjectList(ReadOnlyProjectList projectList) throws IOException;
}
