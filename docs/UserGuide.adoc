...
*  `add n/sample task edited` ...

Outcome: TTask Box (Panel D) will display updated task at index 1 with the new
          name.

* `compare 1`

Outcome: Task Box (Panel B) will display information of current version of the task at
         index 1 ( `sample task` ) and the previous version of it ( `sample task edited` ).
