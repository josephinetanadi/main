...
*Update:* +
Shorthand aliases were added for the following commands: +
_(Legend: command -> alias)_ +
...
Each command alias has a corresponding test as required, and changes to the User Guide have also been documented accordingly.
