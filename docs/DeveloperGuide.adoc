...
* Step 4a. If no same tasks are found after iterating through all the project states, or if there is no difference in all the task
...
* Step 5a. If there is a difference in any of the fields in the comparison, the difference will be showed to the user.
Else Step 4. will continue to look for another version of the chosen task to compare.
