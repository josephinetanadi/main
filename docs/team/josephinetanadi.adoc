...
** Justification: The current implementation of AddressBook is unable to support all the functions of NoteNote and requires us to heavily morph the existing AddressBook application to NoteNote.
** Highlights: The implementation was challenging as it requires us to understand the implementation of all components and modify them simultaneously.
